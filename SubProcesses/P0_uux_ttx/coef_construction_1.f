...
C     Coefficient construction for loop diagram with ID 9
      ...
      CALL ML5_0_CREATE_LOOP_COEFS(WL(1,0,1,20),2,1,8,1,1,35,H)
C     Coefficient construction for loop diagram with ID 10
      ...
      CALL ML5_0_CREATE_LOOP_COEFS(WL(1,0,1,22),2,4,9,1,5,36,H)
C     Coefficient construction for loop diagram with ID 11
      CALL FFV1L2_1(PL(0,0),W(1,5),GC_5,MDL_MT,MDL_WT,PL(0,23),COEFS)
      CALL ML5_0_UPDATE_WL_0_1(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,23))
      CALL FFV1L2_1(PL(0,23),W(1,6),GC_5,MDL_MT,MDL_WT,PL(0,24),COEFS)
      CALL ML5_0_UPDATE_WL_1_1(WL(1,0,1,23),4,COEFS,4,4,WL(1,0,1,24))
      CALL ML5_0_CREATE_LOOP_COEFS(WL(1,0,1,24),2,4,10,1,1,37,H)
