...
C     Counter-term amplitude(s) for loop diagram number 5
      ...
      CALL MP_FFV1_0(W(1,1),W(1,2),W(1,6),UV_GQQG_1EPS,AMPL(2,18))
      CALL MP_FFV1_0(W(1,1),W(1,2),W(1,6),UV_GQQT,AMPL(1,19))
C     Counter-term amplitude(s) for loop diagram number 10
      CALL MP_R2_GG_1_0(W(1,5),W(1,6),R2_GGQ,AMPL(1,20))
      CALL MP_R2_GG_1_0(W(1,5),W(1,6),R2_GGQ,AMPL(1,21))
...
C     Counter-term amplitude(s) for loop diagram number 11
      CALL MP_R2_GG_1_R2_GG_3_0(W(1,5),W(1,6),R2_GGQ,R2_GGT,AMPL(1,25))
