...
std::complex<double> TraceHSDiff(double*,int,double,complex<double>*);
std::complex<double> TraceBornDiff(double*,int,double);
std::complex<double> TraceHSExpDiff(double *, int , double , complex<double> *);
std::complex<double> TraceHSSuperExp(double *, int , double , complex<double> *);
std::complex<double> ColinearDiff(double *, int , double );
std::complex<double> ColinearSuperExp(double *, int , double );
