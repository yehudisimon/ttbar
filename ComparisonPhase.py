...
labels=["LO"]+["NLL"]+["LO \, MG","NLO \; MG"]+["NLO \oplus NLL"]
types=["Born","Diff"]
#types=["Born","Resum"]
color=['c','g','k','magenta','orange','m','y','b']
...
def loadMGLO(res,resExt,ntot):
    ...
    for i in range(1,ntot+1):
        ...
        MadG=np.loadtxt('../tt_VaryMG/MGfO/data/LOqq.txt',delimiter=" ")
        #MadG=np.loadtxt('../tt_VaryMG/MGfO/data/BkpLOgg.txt',delimiter=" ")
        #MadG=np.loadtxt('../tt_VaryMG/MGfO/data/LOgg.txt',delimiter=" ")
...
def loadMGNLO(res,resExt,ntot):
    ...
    for i in range(1,ntot+1):
        ...
        MadG=np.loadtxt('../tt_VaryMG/MGfO/data/NLOqq.txt',delimiter=" ")
        #MadG=np.loadtxt('../tt_VaryMG/MGfO/data/BkpNLOgg.txt',delimiter=" ")
        #MadG=np.loadtxt('../tt_VaryMG/MGfO/data/NLOgg.txt',delimiter=" ")
...
def BuildPlot():
    ...
    axis[0].fill_between(ML,combineExt[0],combineExt[1],alpha=0.5,linewidth=1,antialiased=True,facecolor=color[-2],label=r'${\rm \mathbf{NLO \oplus NLL \, Ron.}}$ ',step='post')
    ...
    axis[1].step(ML,combine[0],c=color[-2], linewidth=0.5,where='post')
    ...
    plt.savefig('ComparisonSpace.svg')
    plt.savefig('ComparisonSpace.png')
    plt.legend([])
    plt.close()
